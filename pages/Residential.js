            ...
            <section className='relative'>
                ...
                <div className='w-full absolute bottom-10 sm:bottom-1/3'>
                    <div className='w-1/3 mx-auto bg-black p-4 rounded-xl opacity-90 lg:w-1/4'>
                        <h2 className='animate-pulse uppercase font-semibold text-center text-white sm:text-lg md:text-xl lg:text-2xl xl:text-3xl'>Residential</h2>
                    </div>
                </div>
            </section>
